...
public class Villager_Sick : MonoBehaviour
{
    ...
    private Vector3 hospitalPosition;
    private Coroutine wanderRoutine;

    void Awake()
    {
        agent = GetComponent<NavMeshAgent>();
        hospitalPosition = hospital.transform.position;
    ...
    private IEnumerator WanderLoop()
    {
        while (true)
        {
            ...
            if (TryGetRandomNavMeshPoint(hospitalPosition, wanderRadius, out Vector3 target))
            {
